...
<section class="relative z-10 overflow-hidden bg-[#F3F4F6] py-20 lg:py-[120px]" id="contact">
                ...
                <div class="mb-12 max-w-[570px] lg:mb-0">
                  <span class="text-primary mb-4 block text-base font-semibold">
                    ...
                    <div class="mb-8 flex w-full max-w-[370px]">
                        ...
                        <div class="w-full">
                            <h4 class="text-dark mb-1 text-xl font-bold">Gabinet Lesko</h4>
                    ...
                    <div class="mb-8 flex w-full max-w-[370px]">
                        ...
                        <div class="w-full">
                            <h4 class="text-dark mb-1 text-xl font-bold">Gabinet Sanok</h4>
                            <p class="text-body-color text-base">
                                SANOK
                                UL. WITKIEWICZA 5<br>
                                CM KONSYLIUM
                    ...
                    <div class="mb-8 flex w-full max-w-[370px]">
                        ...
                        <div class="w-full">
                            <h4 class="text-dark mb-1 text-xl font-bold">Telefon</h4>
                            <p class="text-body-color text-base">Lesko: 605 377 161</p>
                            <p class="text-body-color text-base">Sanok: 502 501 002 </p>
                        </div>
                    </div>
                    <div class="mb-8 flex w-full max-w-[370px]">
                        <div class="bg-primary text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]">
                        ...
                        <div class="w-full">
                            ...
                            <p class="text-body-color text-base">dietetyk.kliniczny.am@gmail.com</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
                <div class="relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
                    <form action="/contact/submit" method="POST" x-data="
                    {
                        ...
                        submitForm(event) {
                            ...
                            .then(result => {
                                ...
                                this.successMessage = 'Dziękuję za wiadomość. Skontaktuję się z Tobą najszybciej jak mogę.';
                            })
                    ...
                    " x-on:submit.prevent="submitForm">
                        ...
                        @csrf
                        <div class="mb-6">
                            <x-forms.input placeholder="Imię i nazwisko" name="name" x-model="formData.name" ::class="errors.name ? 'border-red-500 focus:border-red-500' : ''"></x-forms.input>
                            <template x-if="errors.name">
                                <div x-text="errors.name[0]" class="text-red-500"></div>
                            </template>
                        </div>
                        <div class="mb-6">
                            <x-forms.input placeholder="Twój adres email" name="email" x-model="formData.email" ::class="errors.email ? 'border-red-500 focus:border-red-500' : ''"></x-forms.input>
                            <template x-if="errors.email">
                                <div x-text="errors.email[0]" class="text-red-500"></div>
                            </template>
                        </div>
                        <div class="mb-6">
                            <x-forms.textarea placeholder="Twoja wiadomość" name="message" rows="6" x-model="formData.message" ::class="errors.email ? 'border-red-500 focus:border-red-500' : ''"></x-forms.textarea>
